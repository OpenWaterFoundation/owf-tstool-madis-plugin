...
**This repository is not currently under active development.
Instead, see the [`owf-tstool-synoptic-plugin`](https://github.com/OpenWaterFoundation/owf-tstool-synoptic-plugin)
repository for a more complete solution.
A MADIS plugin may be implemented in the future if resources allow.
Many of these files were copied from the KiWIS plugin but have not been updated for MADIS.**

This repository contains the Open Water Foundation TSTool plugin for the National Atmospheric and Oceanic Administration (NOAA)
Meteorological Assimilation Data Ingest System (MADIS).
This plugin can be installed to enable commands that integrate TSTool with MADIS data services.

TSTool is part of [Colorado's Decision Support Systems (CDSS)](https://www.colorado.gov/cdss).
See the following online resources:

*   [MADIS Web Services Portal](https://madis-data.ncep.noaa.gov/index.html)
*   [MADIS Meteorological Surface Text/XML Viewer (public data)](https://madis-data.ncep.noaa.gov/public/sfcdump.html)
*   [TSTool MADIS Plugin download page](https://software.openwaterfoundation.org/tstool-madis-plugin/)
*   [TSTool MADIS Plugin Documentation](https://software.openwaterfoundation.org/tstool-madis-plugin/latest/doc-user/)
  ...
  cdss-dev/                           Recommended folder for CDSS product development.
    TSTool/                           Recommended folder for TSTool development.
      git-repos/                      Recommended folder for TSTool product repositories.
        owf-tstool-madis-plugin/      Repository working files.
          ...
          owf-tstool-madis-plugin/    Maven project source code and supporting files.
...
This section explains how to add the TSTool MADIS plugin to the TSTool core development environment.
...
6.  Browse to the `cdss-dev/TSTool/git-repos/owf-tstool-madis-plugin/owf-tstool-madis-plugin` folder
    and ***Select Folder***.
...
9.  Right click on `owf-tstool-madis-plugin` in ***Package Explorer*** or ***Project Explorer***
...
1.  Eclipse project:
    1.  The `owf-tstool-madis-plugin` repository is added as a Maven project.
...
2.  Plugin jar file:
    ...
    3.  The above script relies on the `owf-tstool-madis-plugin/src/main/resources/META-INF/MANIFEST.MF`
...
1.  Update the version:
    1.  Update the `src/main/java/owf-tstool-madis-plugin/org/openwaterfoundation/tstool/plugin/madis/PluginMeta.java` source file.
