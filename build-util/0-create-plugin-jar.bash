...
#   ./tstool/NN/plugins/owf-tstool-madis-plugin/ folder for use by TSTool
...
getPluginVersion() {
  # Maven folder structure results in duplicate 'owf-tstool-madis-plugin'?
  # TODO smalers 2022-05-19 need to enable this.
  srcFile="${repoFolder}/owf-tstool-madis-plugin/src/main/java/org/openwaterfoundation/tstool/plugin/madis/PluginMeta.java"  
...
mavenProjectFolder=${repoFolder}/owf-tstool-madis-plugin
...
devBinFolder="${repoFolder}/owf-tstool-madis-plugin/target/classes"
pluginsFolder="$HOME/.tstool/${tstoolMajorVersion}/plugins"
jarFolder="${pluginsFolder}/owf-tstool-madis-plugin"
pluginDepFolder="${pluginsFolder}/owf-tstool-madis-plugin/dep"
jarFile="${jarFolder}/owf-tstool-madis-plugin-${pluginVersion}.jar"
manifestFile="${repoFolder}/owf-tstool-madis-plugin/src/main/resources/META-INF/MANIFEST.MF"
